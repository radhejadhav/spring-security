...
//    @Value("${APP_RATE_DURATIONINMS:#{60000}}")
    private final long rateDuration=10000;

    /**
     * Executed by each call of a method annotated with {@link RateLimit} which should be an HTTP endpoint.
     ...
     */
    @Before("@annotation(com.security.aop.RateLimit)")
